...
var (
	...
	ErrSyncUpstreamTLS                  = errors.New("upstream TLS verification failed")
	ErrSyncUpstreamAuth                 = errors.New("upstream authentication failed")
	ErrSyncUpstreamUnavailable          = errors.New("upstream registry unavailable")
	ErrSyncUpstream                     = errors.New("upstream synchronization failed")
