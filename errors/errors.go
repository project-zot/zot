...
var (
	...
	ErrInvalidRepoTagRefFormat            = errors.New("invalid image reference format, use [repo:tag]")
	...
	ErrGQLProxyUnsupportedTypeForMapMerge = errors.New("unsupported type for map merging")
)
