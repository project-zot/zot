...
var (
	...
	ErrSyncOnDemandDisabled             = errors.New("sync on demand is disabled")
	...
	ErrBlobReaderMissing                = errors.New("blob reader missing for active stream")
	ErrSyncUpstreamDownloadFailed       = errors.New("upstream download failed while streaming blob")
	ErrSyncInvalidManifestMediaType     = errors.New("invalid manifest media type for streaming")
	...
	ErrStreamNeverInitialized           = errors.New("background sync finished without ever streaming this blob")
)
