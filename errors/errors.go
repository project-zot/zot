...
=======
	...
	ErrUserProfileNotFound         = errors.New("userDB: user profile for given email not found")
	ErrTypeAssertionFailed         = errors.New("storage: failed DatabaseDriver type assertion")
	ErrBucketDoesNotExist          = errors.New("DB: bucket does not exist")
	ErrOpenIDProvidertDoesNotExist = errors.New("OpenID: provider does not exist in given config")
>>>>>>> 93fca00... feat: integrate openID auth logic and user profile management
)
