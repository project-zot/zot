...
type MTLSConfig struct {
	// IdentitySources is an ordered list of identity sources to try
	// Options: "CommonName", "Subject", "Email", "URL", "DNSName" (case-insensitive)
	// Default: ["CommonName"] (backward compatible)
	IdentitySources []string `json:"identitySources,omitempty" mapstructure:"identitySources,omitempty"`

	// URISANPattern is a regex pattern to extract identity from URI SAN
	// Only used when IdentitySources contains "URL"
