...
var ErrUnexpectedError = fmt.Errorf("unexpected error")

func (is *ImageStoreMock) Lock(t *time.Time) {
}

func (is *ImageStoreMock) Unlock(t *time.Time) {
}

func (is *ImageStoreMock) RUnlock(t *time.Time) {
}

func (is *ImageStoreMock) RLock(t *time.Time) {
}

func (is *ImageStoreMock) DirExists(d string) bool {
...
func (is *ImageStoreMock) RootDir() string {
...
func (is *ImageStoreMock) InitRepo(name string) error {
...
func (is *ImageStoreMock) ValidateRepo(name string) (bool, error) {
...
func (is *ImageStoreMock) GetRepositories() ([]string, error) {
...
func (is *ImageStoreMock) GetImageManifest(repo string, reference string) ([]byte, string, string, error) {
...
func (is *ImageStoreMock) PutImageManifest(repo string, reference string, mediaType string, body []byte) (
	string, error,
) {
...
func (is *ImageStoreMock) GetImageTags(name string) ([]string, error) {
...
func (is *ImageStoreMock) DeleteImageManifest(name string, reference string) error {
...
func (is *ImageStoreMock) NewBlobUpload(repo string) (string, error) {
...
func (is *ImageStoreMock) GetBlobUpload(repo string, uuid string) (int64, error) {
...
func (is *ImageStoreMock) BlobUploadInfo(repo string, uuid string) (int64, error) {
...
func (is *ImageStoreMock) BlobUploadPath(repo string, uuid string) string {
...
func (is *ImageStoreMock) PutBlobChunkStreamed(repo string, uuid string, body io.Reader) (int64, error) {
...
func (is *ImageStoreMock) PutBlobChunk(repo string, uuid string, from int64, to int64, body io.Reader) (int64, error) {
...
func (is *ImageStoreMock) FinishBlobUpload(repo string, uuid string, body io.Reader, digest string) error {
...
func (is *ImageStoreMock) FullBlobUpload(repo string, body io.Reader, digest string) (string, int64, error) {
...
func (is *ImageStoreMock) DedupeBlob(src string, dstDigest digest.Digest, dst string) error {
...
func (is *ImageStoreMock) DeleteBlob(repo string, digest string) error {
...
func (is *ImageStoreMock) BlobPath(repo string, digest digest.Digest) string {
...
func (is *ImageStoreMock) CheckBlob(repo string, digest string) (bool, int64, error) {
...
func (is *ImageStoreMock) GetBlob(repo string, digest string, mediaType string) (io.Reader, int64, error) {
...
func (is *ImageStoreMock) DeleteBlobUpload(repo string, digest string) error {
...
func (is *ImageStoreMock) GetIndexContent(repo string) ([]byte, error) {
...
func (is *ImageStoreMock) GetBlobContent(repo string, digest string) ([]byte, error) {
...
func (is *ImageStoreMock) GetReferrers(repo string, digest string, mediaType string) (
...
func (is *ImageStoreMock) URLForPath(path string) (string, error) {
...
func (is *ImageStoreMock) RunGCRepo(repo string) {
	if is != nil && is.runGCRepoFn != nil {
		is.runGCRepoFn(repo)
	}	
}

func (is *ImageStoreMock) RunGCPeriodically(gcInterval time.Duration) {
...
func TestRoutes(t *testing.T) {
	Convey("Make a new controller", t, func() {
		...
		Convey("Get manifest", func() {
			...
			ctlr.StoreController.DefaultStore = &ImageStoreMock{
				getImageManifestFn: func(repo string, reference string) ([]byte, string, string, error) {
		...
		Convey("UpdateManifest ", func() {
			testUpdateManifest := func(urlVars map[string]string, ism *ImageStoreMock) int {
		...
		Convey("DeleteManifest", func() {
			testDeleteManifest := func(headers map[string]string, urlVars map[string]string, ism *ImageStoreMock) int {
				ctlr.StoreController.DefaultStore = ism
		...
		Convey("DeleteBlob", func() {
			testDeleteBlob := func(urlVars map[string]string, ism *ImageStoreMock) int {
				ctlr.StoreController.DefaultStore = ism
		...
		Convey("CheckBlob", func() {
			testCheckBlob := func(urlVars map[string]string, ism *ImageStoreMock) int {
				ctlr.StoreController.DefaultStore = ism
		...
		Convey("GetBlob", func() {
			testGetBlob := func(urlVars map[string]string, ism *ImageStoreMock) int {
				ctlr.StoreController.DefaultStore = ism
				request, _ := http.NewRequestWithContext(context.TODO(), "GET", baseURL, nil)
				request = mux.SetURLVars(request, urlVars)
				response := httptest.NewRecorder()
		...
		Convey("ListRepositories with Authz", func() {
			...
			ctlr.StoreController.SubStore = map[string]storage.ImageStore{
				"test1": &ImageStoreMock{
					getRepositoriesFn: func() ([]string, error) {
						return []string{"repo1"}, nil
					},
				},
				"test2": &ImageStoreMock{
					getRepositoriesFn: func() ([]string, error) {
		...
		Convey("Get blob with redirect", func() {
			// overwrite controller storage
			ctlr.StoreController.DefaultStore = &ImageStoreMock{
				urlForPathFn: func(path string) (string, error) {
					return "redirected_path", nil
				},
				blobPathFn: func(repo string, digest digest.Digest) string {
					return repo + "/" + digest.String()
				},
			}
			ctlr.Config.Storage.StorageDriver = map[string]interface{}{
				"rootDir":  "zot",
				"name":     "s3",
				"redirect": true,
			}
		...
		Convey("Get blob with failed redirect", func() {
			ctlr.StoreController.DefaultStore = &ImageStoreMock{
				urlForPathFn: func(path string) (string, error) {
					return "redirected_path", zerr.ErrBadBlob
				},
				blobPathFn: func(repo string, digest digest.Digest) string {
					return repo + "/" + digest.String()
				},
