...
func TestServeExtensions(t *testing.T) {
	...
	Convey("config file with empty extensions", t, func(c C) {
		...
		data, err := os.ReadFile(logFile.Name())
		So(err, ShouldBeNil)
		So(string(data), ShouldContainSubstring, "\"Extensions\":{\"Search\":null,\"Sync\":null,\"Metrics\":null,\"Scrub\":null,\"Lint\":null,\"Mgmt\":null") //nolint:lll // gofumpt conflicts with lll
	})
}
...
func testWithMetricsEnabled(cfgContentFormat string) {
	...
	So(string(data), ShouldContainSubstring,
		"\"Extensions\":{\"Search\":null,\"Sync\":null,\"Metrics\":{\"Enable\":true,\"Prometheus\":{\"Path\":\"/metrics\"}},\"Scrub\":null,\"Lint\":null,\"Mgmt\":null") //nolint:lll // gofumpt conflicts with lll
}
...
func TestServeMetricsExtension(t *testing.T) {
	...
	Convey("with explicit disable", t, func(c C) {
		...
		So(err, ShouldBeNil)
		So(string(data), ShouldContainSubstring,
			"\"Extensions\":{\"Search\":null,\"Sync\":null,\"Metrics\":{\"Enable\":false,\"Prometheus\":{\"Path\":\"/metrics\"}},\"Scrub\":null,\"Lint\":null,\"Mgmt\":null") //nolint:lll // gofumpt conflicts with lll
	})
}
...
func TestServeScrubExtension(t *testing.T) {
	...
	Convey("scrub implicitly enabled", t, func(c C) {
		...
		So(dataStr, ShouldContainSubstring,
			"\"Extensions\":{\"Search\":null,\"Sync\":null,\"Metrics\":null,\"Scrub\":{\"Enable\":true,\"Interval\":86400000000000},\"Lint\":null,\"Mgmt\":null") //nolint:lll // gofumpt conflicts with lll
	...
	Convey("scrub implicitly enabled, but with scrub interval param set", t, func(c C) {
		...
		dataStr := string(data)
		So(dataStr, ShouldContainSubstring,
			"\"Extensions\":{\"Search\":null,\"Sync\":null,\"Metrics\":null,\"Scrub\":{\"Enable\":true,\"Interval\":3600000000000},\"Lint\":null,\"Mgmt\":null") //nolint:lll // gofumpt conflicts with lll
		So(dataStr, ShouldContainSubstring,
			"Scrub interval set to too-short interval < 2h, changing scrub duration to 2 hours and continuing.")
	})
	...
	Convey("scrub explicitly disabled", t, func(c C) {
		...
		dataStr := string(data)
		So(dataStr, ShouldContainSubstring,
			"\"Extensions\":{\"Search\":null,\"Sync\":null,\"Metrics\":null,\"Scrub\":{\"Enable\":false,\"Interval\":86400000000000},\"Lint\":null,\"Mgmt\":null") //nolint:lll // gofumpt conflicts with lll
...
func TestServeSearchEnabled(t *testing.T) {
	...
	Convey("search implicitly enabled", t, func(c C) {
		...
		substring := "\"Extensions\":{\"Search\":{\"Enable\":true,\"CVE\":null},\"Sync\":null,\"Metrics\":null,\"Scrub\":null,\"Lint\":null,\"Mgmt\":null}" //nolint:lll // gofumpt conflicts with lll
...
func TestServeSearchEnabledCVE(t *testing.T) {
	...
	Convey("search implicitly enabled with CVE param set", t, func(c C) {
		...
		substring := "\"Extensions\":{\"Search\":{\"Enable\":true,\"CVE\":{\"UpdateInterval\":3600000000000,\"Trivy\":null}},\"Sync\":null,\"Metrics\":null,\"Scrub\":null,\"Lint\":null,\"Mgmt\":null" //nolint:lll // gofumpt conflicts with lll
		found, err := readLogFileAndSearchString(logPath, substring, readLogFileTimeout)
		So(found, ShouldBeTrue)
		So(err, ShouldBeNil)
...
func TestServeSearchDisabled(t *testing.T) {
	...
	Convey("search explicitly disabled", t, func(c C) {
		...
		dataStr := string(data)
		So(dataStr, ShouldContainSubstring,
			"\"Extensions\":{\"Search\":{\"Enable\":false,\"CVE\":{\"UpdateInterval\":10800000000000,\"Trivy\":null}},\"Sync\":null,\"Metrics\":null,\"Scrub\":null,\"Lint\":null,\"Mgmt\":null}") //nolint:lll // gofumpt conflicts with lll
