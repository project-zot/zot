...
var (
	...
	fileWriterSize = 12
	fileInfoSize   = 10
	errorText      = "new azure blob error"
	errAzureBlob   = errors.New(errorText)
...
func createMockStorageWithMockCache(rootDir string, dedupe bool, store driver.StorageDriver,
	...
	il := azure.NewImageStore(rootDir, "", dedupe, false, log, metrics, nil, store, cacheDriver)
...
func createObjectsStoreTable(_ string, _ string, _ bool, _ string) (
	driver.StorageDriver,
	storageTypes.ImageStore,
	error,
) {
	...
	Convey("Without dedupe", t, func(c C) {
		...
		Convey("Test storage driver errors", func(c C) {
			imgStore = createMockStorage(testDir, tdir, false, &StorageDriverMock{
				ListFn: func(ctx context.Context, path string) ([]string, error) {
					return []string{testImage}, errAzureBlob
				},
				MoveFn: func(ctx context.Context, sourcePath, destPath string) error {
					return errAzureBlob
				},
				GetContentFn: func(ctx context.Context, path string) ([]byte, error) {
					return []byte{}, errAzureBlob
				},
				PutContentFn: func(ctx context.Context, path string, content []byte) error {
					return errAzureBlob
				},
				WriterFn: func(ctx context.Context, path string, isAppend bool) (driver.FileWriter, error) {
					return &FileWriterMock{}, errAzureBlob
				},
				ReaderFn: func(ctx context.Context, path string, offset int64) (io.ReadCloser, error) {
					return io.NopCloser(strings.NewReader("")), errAzureBlob
				},
				WalkFn: func(ctx context.Context, path string, f driver.WalkFn, options ...func(*driver.WalkOptions)) error {
					return errAzureBlob
				},
				StatFn: func(ctx context.Context, path string) (driver.FileInfo, error) {
					return &FileInfoMock{}, errAzureBlob
				},
				DeleteFn: func(ctx context.Context, path string) error {
					return errAzureBlob
				},
		...
		Convey("Test ValidateRepo", func(c C) {
			...
			imgStore = createMockStorage(testDir, tdir, false, &StorageDriverMock{
				ListFn: func(ctx context.Context, path string) ([]string, error) {
					return []string{testImage, testImage}, errAzureBlob
				},
			})
...
func TestAzureBlobDedupe(t *testing.T) {
	tskip.SkipAzureBlob(t)
	tskip.SkipDynamo(t)
	...
	Convey("Dedupe with dynamodb", t, func(c C) {
		...
		storeDriver, imgStore, _ := createObjectsStoreTable(testDir, tdir, true, tdir)
		defer cleanupStorage(storeDriver, testDir)
...
func TestAzureBlobPullRange(t *testing.T) {
	tskip.SkipAzureBlob(t)
...
func TestAzureBlobManifestImageIndex(t *testing.T) {
	tskip.SkipAzureBlob(t)
...
func TestAzureBlobDedupeErr(t *testing.T) {
	tskip.SkipAzureBlob(t)
	...
	Convey("Test DedupeBlob", t, func(c C) {
		...
		imgStore = createMockStorage(testDir, tdir, true, &StorageDriverMock{
			...
			StatFn: func(ctx context.Context, path string) (driver.FileInfo, error) {
				return driver.FileInfoInternal{}, errAzureBlob
			},
		})
