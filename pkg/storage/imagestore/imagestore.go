...
/*
GetBlobUploads returns all blob uploads present in the repository. The caller function MUST lock from outside.
*/
func (is *ImageStore) GetBlobUploads(repo string) ([]string, error) {
...
func (is *ImageStore) CleanupRepo(repo string, blobs []godigest.Digest, removeRepo bool) (int, error) {
	...
	blobUploads, _ := is.GetBlobUploads(repo)
