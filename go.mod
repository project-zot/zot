...
replace (
	github.com/aquasecurity/fanal => github.com/project-zot/fanal v0.0.0-20220603030302-e9ffe9cea941
	github.com/aquasecurity/trivy-db => github.com/project-zot/trivy-db v0.0.0-20220603030445-0e7ca6b35a56
