...
test-minimal: testdata-images
	env GOEXPERIMENT=jsonv2 go test -failfast -trimpath -race -timeout 20m -cover -coverpkg ./... -coverprofile=coverage-minimal.txt -covermode=atomic ./...
	rm -rf /tmp/getter*; rm -rf /tmp/trivy*
